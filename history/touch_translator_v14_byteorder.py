...
#
# This single fix explains every calibration problem in the
# project: the periodic wild jumps were DECODE rollovers at
# each 7-bit boundary, not touch glitches. All the filtering
...
print("=" * 50)
print("EOS Touch Translator v14 - BYTE ORDER FIXED")
