# ============================================================
# EOS Touch Translator - v18  *** 0-255 OUTPUT SCALING ***
#
# KEY FIX: the genuine pointercal expects raw touch ~0-255
# (what the original resistive controller sent). Every button
# coord Brandon measured (38,40 / 50,122 / 65,55) sits in 0-130,
# proving the screen uses a ~0-255 space, NOT 0-1023. Outputting
# 0-1023 was ~4x too large - that caused ALL the compression and
# edge overflow. This version maps each axis to 0-255 so the
# EXISTING genuine calibration just works, no re-calibration.
#
# Full fix stack:
...
SWAP_XY  = False
SMOOTH_SAMPLES = 5
OUT_MAX = 255   # match genuine pointercal's expected raw range (~0-255)
...
print("EOS Touch Translator v18 - 0-255 OUTPUT (matches genuine cal)")
