# ============================================================
# EOS Touch Translator - v19  *** 8-BIT OUTPUT (0-255) ***
#
# 8-BIT (0-255) variant to compare against the 7-bit v18.
# Brandon reported 0-255 was also showing promise earlier before
# the 0-1023 detour. This maps each axis to 0-255 to test which
# range the genuine pointercal actually expects. Compare cursor
# tracking between v18 (0-127) and this v19 (0-255) and keep
# whichever tracks the finger best across the whole screen.
#
...
BAUD = 9600
LEARN_SECONDS = 15
OUT_MAX = 255            # 8-bit output range
...
print("EOS Touch Translator v19 - 8-BIT OUTPUT (0-255)")
...
while True:
    ...
    if r:
        ...
        if touch:
            ...
            print("raw({:5d},{:5d}) 8bit({:3d},{:3d})".format(rx,ry,mx,my))
            was_touching = True
        else:
            if was_touching:
