...
SMOOTH_SAMPLES = 7
WARMUP_SAMPLES = 2        # ignore first N samples of each touch
OUTLIER_TOL    = 150      # reject samples >this far from running median (10-bit units)
STABLE_TOL     = 60       # window must agree within this to emit
...
print("=" * 50)
print("EOS Touch Translator v12 - tuned responsiveness")
